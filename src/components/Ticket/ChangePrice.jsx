...
const ChangePrice = () => {
  ...
  const [editItemIndex, setEditItemIndex] = useState(null); // Indeks elementu, który jest edytowany
  const [ticketPrices, setTicketPrices] = useState([]);

  useEffect(() => {
    // Pobierz wartość endDate z bazy danych i zaktualizuj stan komponentu
    database
  ...
  const handleCancel = () => {
    setShowDatePicker(false);
    setEditItemIndex(null); // Zresetuj indeks elementu edytowanego
  };
  ...
  const handleItemBoxButtonClick = (index) => {
    setEditItemIndex(index); // Ustaw indeks elementu edytowanego
  };
